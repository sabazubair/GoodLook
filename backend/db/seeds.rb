...
styles = Style.create([
  {name: "Avant-garde", description: "You have an ultramodern style and it serves as an extension of your creative mind and lifestyle. You love to take chances and make dramatic statements no matter the day. Fabrics that lend to the Avant-garde style are cotton, linen, leather, as well as sheer or lace pieces that can add value to your composition. Choose modern cuts, with voluminous geometric structures, asymmetric hemlines, or even exaggerated ruffles and pleats. You share your style with Janelle Monae.", image: "/assets/results/ag_0_result.jpg"},
  {name: "Bohemian", description:"You lean to a more relaxed, lived-in, funky kinda flow, arm candy is a must and you like a lot of it. Denim, shade, and velvet will be paired in just the right way that creates a style that works for you and others love it. You love natural fabrics and earth tones. The 1960s and the early 1970s is your claim to style in an effortless way. You share your style with Vanessa Hudgens.", image: "/assets/results/boho_1_result.jpeg"},
  {name: "Classic", description: "You enjoy wardrobe that is high quality in fabric and structured in fit. You believe less is more and want to look sharp and appropriate wherever you go. The classic dresser communicates a sense of sophistication. Refinement and attention to details are important. Patterns you enjoy are solids, stripes and possibly plaid. You share your style with Amal Clooney.", image: "/assets/results/amal_result.jpg"},
  {name: "Romantic", description: "You are playful, light-hearted and full of life. The Romantic dresser communicates graciousness, charisma and charm. You may enjoya fit that lends to flowy or fitted, perhaps a combination of both...fit and flair. Patterns you enjoy are floral, embroidery, jeweled embellishments. Texture you enjoy are lace, sheer fabrics, and chiffon. What is life without a dash of personality? You share your style with Mindy Kaling.", image: "assets/results/mindyresult1.jpg"},
  {name: "Urban", description: "You are edgy and trendy. The Urban dresser is influenced by style born in the street which is constantly changing. You keep up with the trends while incorporating comfort in every look. You may enjoy outfits that include distressed jeans, graphic t-shirts, tracksuits and hoodies. Your colours include greys, blacks and camouflage. You share your style with Zoe Kravitz.", image: "assets/results/zoe_result1.jpg"}
])
...
question_choice_1a = QuestionChoice.create(
  {
    ...
    image: "/assets/question_1/janelleMonae.jpg"
  })
...
question_choice_1b = QuestionChoice.create(
  {
    ...
    image: "/assets/question_1/vanessaHudgensq1.jpg"
  })
...
question_choice_1c = QuestionChoice.create(
  {
    ...
    text: "c. Amal Clooney",
    image: "/assets/question_1/amalC1.jpg"
  })
